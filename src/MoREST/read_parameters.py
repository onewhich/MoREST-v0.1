...
class read_parameters:
    ...
    def read_barostat_parameters(self, i_parameter):
        ...
        elif i_parameter.split()[0].upper() == 'Barostat_space_size'.upper():
            self.barostat_parameters['barostat_space_size'].append(float(i_parameter.split()[1]))
    ...
    def read_scattering_parameters(self, i_parameter):
        if i_parameter.split()[0].upper() == 'Scattering_initialization'.upper():
        ...
        elif i_parameter.split()[0].upper() == 'Scattering_fix_target'.upper():
            if i_parameter.split()[1].upper() == 'True'.upper():
            ...
            if i_parameter.split()[1].upper() == 'True'.upper():
                self.scattering_parameters['scattering_fix_incident'] = True
            elif i_parameter.split()[1].upper() == 'False'.upper():
                self.scattering_parameters['scattering_fix_incident'] = False
    ...
    def get_scattering_parameters(self, log_morest=None):
        ...
        if not (('scattering_V_collision' in self.scattering_parameters) or ('scattering_E_collision' in self.scattering_parameters)):
            ...
            self.scattering_parameters['scattering_Maxwell_Boltzmann_collision'] = False
    ...
    def get_ITS_parameters(self, log_morest=None):
        ...
        self.ITS_parameters['its_replica_temperatures'] = np.around(self.ITS_parameters['its_replica_temperatures'], decimals=6)
