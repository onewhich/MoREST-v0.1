...
class ml_potential:
    ...
    def generate_Al2F2_representation(Al2F2):
        ...
        Eb_rAl2 = gpr_Al2.predict(np.array([inverse_r_Al1_Al3,exp_r_Al1_Al3]))
        Eb_rF2 = gpr_F2.predict(np.array([inverse_r_F2_F4,exp_r_F2_F4]))
        Eb_rAlF_1 = gpr_AlF.predict(np.array([inverse_r_Al1_F2,exp_r_Al1_F2]))
        Eb_rAlF_2 = gpr_AlF.predict(np.array([inverse_r_Al3_F4,exp_r_Al3_F4]))
        Eb_rAlF_3 = gpr_AlF.predict(np.array([inverse_r_Al1_F4,exp_r_Al1_F4]))
        Eb_rAlF_4 = gpr_AlF.predict(np.array([inverse_r_Al3_F2,exp_r_Al3_F2]))
        
        subfeature_AlF2_1 = np.array([Eb_rAlF_1, inverse_r_Al1_F2, exp_r_Al1_F2, Eb_rAlF_3, inverse_r_Al1_F4, exp_r_Al1_F4, Eb_rF2, inverse_r_F2_F4, exp_r_F2_F4])
        subfeature_AlF2_2 = np.array([Eb_rAlF_2, inverse_r_Al3_F4, exp_r_Al3_F4, Eb_rAlF_4, inverse_r_Al3_F2, exp_r_Al3_F2, Eb_rF2, inverse_r_F2_F4, exp_r_F2_F4])
        subfeature_Al2F_1 = np.array([Eb_rAlF_1, inverse_r_Al1_F2, exp_r_Al1_F2, Eb_rAlF_4, inverse_r_Al3_F2, exp_r_Al3_F2, Eb_rAl2, inverse_r_Al1_Al3, exp_r_Al1_Al3])
        subfeature_Al2F_2 = np.array([Eb_rAlF_2, inverse_r_Al3_F4, exp_r_Al3_F4, Eb_rAlF_3, inverse_r_Al1_F4, exp_r_Al1_F4, Eb_rAl2, inverse_r_Al1_Al3, exp_r_Al1_Al3])
        ...
        representation = np.array([E_Al, E_F,
                          ...
                          Eb_AlF2_1, Eb_AlF2_2, Eb_Al2F_1, Eb_Al2F_2])
